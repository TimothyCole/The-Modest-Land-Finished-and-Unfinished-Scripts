...
GUI.titleRect = {61, 121, 177, 255}
GUI.optionText = {255, 255, 255, 255, 6}
GUI.optionRect = {0, 0, 0, 150}
GUI.scroller = {255, 255, 255, 240}
GUI.scrollerText = {0, 0, 0, 255, 6}
...
function Menu.Title(title)
	GUI.Text(title, GUI.titleText, {menuX, 0.094}, {0.85, 0.85}, true)
...
function Menu.Option(option, select)
	...
	if not select then
		if(currentOption <= GUI.maxVisOptions and optionCount <= GUI.maxVisOptions) then
			GUI.Text(option, textColor, {menuX - 0.1, optionCount * 0.035 + 0.125},  {0.5, 0.5 }, false)
		...
		elseif (optionCount > currentOption - GUI.maxVisOptions and optionCount <= currentOption) then
			GUI.Text(option, textColor, { menuX - 0.1, optionCount - (currentOption - GUI.maxVisOptions) * 0.035 + 0.125 }, { 0.5, 0.5 }, false);
...
function Menu.Int(option, int, min, max, cb)
	...
	if (currentOption <= GUI.maxVisOptions and optionCount <= GUI.maxVisOptions) then
		GUI.Text(tostring(int), textColor, { menuX + 0.068, optionCount * 0.035 + 0.125 }, { 0.5, 0.5 }, true)
	elseif (optionCount > currentOption - GUI.maxVisOptions and optionCount <= currentOption) then
		GUI.Text(tostring(int), textColor, { menuX + 0.068, optionCount - (currentOption - maxVisOptions) * 0.035 + 0.125 }, { 0.5, 0.5 }, true)
	end
